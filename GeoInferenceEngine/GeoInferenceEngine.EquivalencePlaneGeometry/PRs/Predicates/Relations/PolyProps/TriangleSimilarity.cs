...
[Description("相似三角形", "三角形相似")]
public class TriangleSimilarity : Knowledge
{
    public TriangleSimilarity(Point point1, Point point2, Point point3, Point point4, Point point5, Point point6)
    {
    ...
    public override string ToString() => $"三角形{Properties[0]}{Properties[1]}{Properties[2]}与三角形{Properties[3]}{Properties[4]}{Properties[5]}相似".Replace("点", string.Empty);

    public override void Normalize()
    {
        NormalizeForTriangleSimilarity();
    }
    void NormalizeForTriangleSimilarity()
    {
