...
public class SREE : Knowledge
{
    ...
    /// 构造函数
    /// </summary>
    public SREE(Expr expr,params SLR[] Slr )
    {
        Add(expr);
        Add(Slr);
    ...
    public override string ToString()
    {
        ...
        {
            var segmentLengthRatio = (SLR)Properties[i];
            sb.Append($"({segmentLengthRatio.Properties[0]}{segmentLengthRatio.Properties[1]}/{segmentLengthRatio.Properties[1]}{segmentLengthRatio.Properties[2]})");
